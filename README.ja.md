...
たとえば相談系subredditに、役に立ちそうだけれど開示がない回答が来たとします。人間が書いたのか、AI補助なのか、AI生成なのか、外から断定するのは危険です。でも、モデレーターは何もせず放置するわけにもいきません。

Coexistence Console は、その1件の迷う投稿を次の流れに変えます。

1. キューが `missing disclosure`、`low-context post`、`needs moderator review` など、観測できる理由を出します。
2. AIトリアージ支援が、安全なラベル候補、見える理由2つ、次の操作を提案します。ただし「AI検出」とは言いません。
3. モデレーターが、開示依頼、ラベル付け、承認、レビュー済み、理由付き削除の中から選びます。
4. ActionLog に、何を、なぜ、いつ処理したかが残ります。
5. Analytics で、コミュニティ全体の傾向と削減時間を見て、ルールを調整できます。

大事なのは、AIかどうかを裁くことではありません。曖昧な投稿を、速く、一貫して、説明できる形で処理できることです。
